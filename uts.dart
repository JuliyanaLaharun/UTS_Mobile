...
class Pemesanan {
  ...
  void cetakStruk() {
    print(
      ...
      "Total Tarif: Rp${totalTarif.toStringAsFixed(2)}\n",
    );
  }
...
void main() {
  ...
  var taksi = Taksi("T01", "Taksi Sharp", 8000, 4, 12.5);
  var bus = Bus("B01", "Bus Ternate", 3000, 40, true);
  var pesawat = Pesawat("P01", "Lion Air", 1500000, 180, "Ekonomi");

  // Membuat daftar pemesanan
  List<Pemesanan> daftar = [];
  daftar.add(buatPemesanan(taksi, "Juliyana", 1, "PSN01"));
  daftar.add(buatPemesanan(bus, "Nana", 10, "PSN02"));
  daftar.add(buatPemesanan(pesawat, "Yana", 2, "PSN03"));
